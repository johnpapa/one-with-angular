...
export class DataServiceStub {
  ...
  getPlanets = jasmine.createSpy('getPlanets');
  getAllegiances = jasmine.createSpy('getAllegiances');
  getPlanetSummary = jasmine.createSpy('getPlanetSummary');
  getAllegianceSummary = jasmine.createSpy('getAllegianceSummary');
